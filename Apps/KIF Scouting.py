...
def prep_similarity_df(geo_input, region, tiers, time_frame):
    ...
    if gender == 'Women':
        sim_lg_lookup = pd.read_csv('https://raw.githubusercontent.com/griffisben/Wyscout_Prospect_Research/main/league_info_lookup_women.csv')
...
rank_11_base = read_csv('https://raw.githubusercontent.com/griffisben/misc-code/main/RoleRanksApp/Ranking_XI_KIF.csv')
role_position_lookup = read_csv('https://raw.githubusercontent.com/griffisben/misc-code/main/RoleRanksApp/Role_Positions_Lookup_KIF.csv')
...
if gender == 'Women':
    ...
    default_danish_league = "Danish Elitedivisionen"
    default_danish_season = "24-25"
##########
...
with similarity_tab:
    with st.form('Similar Player Search'):
        ...
        if gender == 'Women':
            similar_player_lg_lookup = pd.read_csv('https://raw.githubusercontent.com/griffisben/Wyscout_Prospect_Research/main/league_info_lookup_women.csv')
...
with filter_tab:
    with st.form('Position Filter Min Filters'):
        ...
        if gender == 'Women':
            similar_player_lg_lookup_filters = pd.read_csv('https://raw.githubusercontent.com/griffisben/Wyscout_Prospect_Research/main/league_info_lookup_women.csv')
...
with ranking_tab:
    with st.form('Geo Selection for Ranking'):
        ...
        if gender == 'Women':
            similar_player_lg_lookup_ranking = pd.read_csv('https://raw.githubusercontent.com/griffisben/Wyscout_Prospect_Research/main/league_info_lookup_women.csv')
